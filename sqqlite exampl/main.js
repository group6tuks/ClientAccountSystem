...
const ProjectRepository = require('./project_repo')  
const TaskRepository = require('./task_repo')

function main() {  

  const dao = new AppDAO('./database.sqlite3')
  const blogProjectData = 'Write Node.js - SQLite Tutorial'
  ...
  projectRepo.createTable()
    ...
    .then((projectId)=> {console.log(`project id = ${project.id}`)
