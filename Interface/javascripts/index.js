...
db.serialize(() =>{
	...
	//db.run("userid");
	//db.run("INSERT INTO account (accountID, userID, accountType, currentBalance,deactivate) VALUES (2,22, 'Savings', 1000.00,'')");
	//db.run("INSERT INTO account (accountID, userID, accountType, currentBalance) VALUES (3,1, 'Cheque', 80.00,'x')");
	...
	db.serialize(() =>{
		...
		console.log(queries.selectAccountType(125875));
